...
```bash
curl https://start.spring.io/starter.tgz -d dependencies=web -d baseDir=simple-microservice -d bootVersion=2.3.2.RELEASE -d javaVersion=1.8 | tar -xzvf -
```

> We force the Spring Boot version to be 2.3.2.RELEASE
